...
class Machine:
    def __init__(self,host,user='ec2-user',cores=32,work_root='/home/ec2-user'):
        self.host = host
        self.user = user
        self.cores = cores
    ...
    def setup(self,codec):
        ...
        if subprocess.call(['./transfer_git.sh',self.host,codec,self.user,self.work_root]) != 0:
...
class Slot:
    ...
    def get_file(self, remote, local):
        subprocess.call(['scp','-i','daala.pem', self.machine.user+'@'+self.machine.host+':'+remote,local])
