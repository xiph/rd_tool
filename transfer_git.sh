...
$SSH ec2-user@$1 "cd daala ; ./autogen.sh ; PKG_CONFIG_PATH=/usr/local/lib/pkgconfig ./configure --disable-player --enable-logging --enable-dump-images ; make -j4 ; make tools -j4" > /dev/null
